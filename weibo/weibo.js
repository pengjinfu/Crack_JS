...
function getPwd(pubkey,servertime,nonce,pwd) {
...
function getPrelte(exectime) {
    var preloginTimeStart = (new Date).getTime()
    preloginTime = (new Date).getTime() - preloginTimeStart - (parseInt(exectime, 10) || 0)
return preloginTime
}